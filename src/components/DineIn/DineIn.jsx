                              ...
                              <svg
                                className={
                                  data.tableInfo === "avilable__btn"
                                    ? "svgDinein avilableTable "
                                    : data.tableInfo === "occupied__btn"
                                    ? "svgDinein occupiedTable "
                                    : data.tableInfo === "doneSoon__btn"
                                    ? "svgDinein DoneSoonTable "
                                    : data.tableInfo === "reservation__btn"
                                    ? "svgDinein ReservationTable "
                                    : "svgDinein"
                                }
                                xmlns="http://www.w3.org/2000/svg"
                                width="100"
