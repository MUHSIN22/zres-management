      ...
      {!hourlyBreakdown && (
        <>
          ...
          <div className="section__main__container">
            ...
            <div className=" grid__item__2__warpper">
              <div className=" grid__item__in__wrapper1">
              ...
              <div className=" grid__item__in__wrapper2">
                <div className="top__icon__section">
                  <FontAwesomeIcon
                    style={{ color: "#fdc307" }}
                    icon={faFolder}
          ...
          {/* order by location sales by location top selling item */}
          <div className="section__main__container">
            <div className="gridBox grid__item__1">
              <div className="top__icon__section">
                <FontAwesomeIcon
                  style={{ color: "#fdc307" }}
                  icon={faFolder}
          ...
          <div className="bottom__div__section">
            <div className="div__area__section div__section__one">
              <div className="top__icon__section">
                <FontAwesomeIcon
                  style={{ color: "#fdc307" }}
                  icon={faFolder}
            ...
            <div className="div__area__section div__section__mid">
              <div
                className="mid__chid__section top__mid__section"
              ...
              <div className="mid__chid__section mid__mid__section">
                <div className="top__icon__section">
                  <FontAwesomeIcon
                    style={{ color: "#fdc307" }}
                    icon={faFolder}
              ...
              <div className="mid__chid__section bottom__mid__section">
                <div className="top__icon__section">
                  <FontAwesomeIcon
                    style={{ color: "#fdc307" }}
                    icon={faFolder}
            ...
            <div className="div__area__section div__dection__two">
