...
function DashboadSales() {
  ...
  const handleClose = (type) => {
    setAnchorEl(null);
    dashboardServices.getFilteredSalesData(startDate, toDate, type)
      .then(res => {
        setAllData(res);
        setChartOfSales([
  ...
  const handleFilter = () => {
    dashboardServices.getFilteredSalesData(startDate,toDate)
      .then(res => {
        setAllData(res)
        setChartOfSales([
          { name: "Sales", value: res.ChartOfSales[0].Sale },
...

      {
        ...
        <div className="dashboard-sales-container">
          ...
          <div className="lineChart__section">
            <LineChartSection data={allData.SalesLineChart} />
          </div>
          ...
          <div className="total-sales">
            ...
            <h2>{allData.TotalSales[0].TotalSale}</h2>
          </div>
          ...
          <div className="modification-and-reprint">
            ...
            <h2>{allData.Reprinted[0].Reprint}</h2>
          </div>
          ...
          <div className="gridBox grid__item__1 top-selling-items">
            ...
            {
              allData.TopSellingItems[0] &&
              <Fragment>
                <h2>{allData.TopSellingItems[0].ItemName}</h2>
                <h4>{allData.TopSellingItems[0].NoOfSales} Sold</h4>
              </Fragment>
            }
            <hr />
            <ol>
              {
                allData.TopSellingItems.map((item, index) => (
                  <li key={index}>
          ...
          <div className="div__area__section div__section__one staff-wise-report">
            ...
            <ol className="staff_">
              {
                allData.StaffWise.map((item, index) => (
                  <li key={index}>
          ...
          <div className="mid__chid__section mid__mid__section cancelled-orders">
            ...
            <div className="inner__section__contaier">
              <h2>{allData.CancelledOreders[0].NoOfCancelled}</h2>
              <h5>OMR Need</h5>
            </div>
          </div>
          ...
          <div className="mid__chid__section bottom__mid__section total-orders">
            ...
            <h4>Total Orders</h4>
            <div className="inner__section__contaier">
              <h2>{allData.TotalOrder[0].TotalOrders}</h2>
              <h5>OMR Need</h5>
            </div>
          </div>
          ...
          <div className="div__area__section div__dection__two top-grossing-items">
            ...
            {
              allData.TopGrossingItems[0] &&
              <>
                <h2>{allData.TopGrossingItems[0].ItemName}</h2>
                <h4>{allData.TopGrossingItems[0].NoOfSales} Sold</h4>
              </>
            }
            <hr />
            <ol>
              {
                allData.TopGrossingItems.map((item, index) => (
                  <li key={index}>
                    <div className="inner__li">
                      <h5>{item.ItemName}</h5> <h5>{item.NoOfSales} sold</h5>{" "}
                    </div>
