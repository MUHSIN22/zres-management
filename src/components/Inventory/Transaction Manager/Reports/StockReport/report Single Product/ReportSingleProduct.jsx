...
import "./reportSingleProduct.scss";
...
function ReportSingleProduct({ SetClickedTr }) {
  return (
    <div className="ReportSingleProduct">
      <div className="headder__Section">
        <div className="left">
          <ArrowBackIcon onClick={() => SetClickedTr("")} />
          <h3>Stock Report as 22/11/2021 to 02/12/2021</h3>
        </div>
        ...
        <div className="table__sections">
          <table className="table">
            ...
            <tbody>
              {Date.map((datas) => (
                <tr keys={datas.id}>
                  <td style={{ backgroundColor: "rgba(193,192,228,0.5)" }}>
                    {datas.SINO}
                  </td>
            ...
            <tfoot>
              <tr>
                <td style={{ backgroundColor: "rgba(193,192,228,0.5)" }}></td>
                <td></td>
                <td colspan="2">
                  <h4 style={{ color: "red" }}>Closing Stock</h4>
                </td>
                <td></td>
